...
namespace Hospital_Management_System.Controllers
{
    public class LoginController : Controller
    {
        ...
        //---------------------------------------------------------------------------------------------------------------------
        shcsEntities dbcontext;
        public LoginController()
        {
            dbcontext = new shcsEntities();
        }
        ...
        public ActionResult Register(AccountModels obj)
        {
            ...
            profile.First_Name = obj.fname;
            profile.Middle_Name = obj.mname;
            profile.Last_Name = obj.lname;
            profile.Email = obj.email;
            profile.Phone_No = obj.phone_no;
            profile.Password = obj.password;
            profile.Date_Of_Birth = obj.date_of_birth;
            profile.Address = obj.address;
            profile.Gender = obj.Gender;
            profile.Blood = obj.blood;
            profile.Account_Type = obj.AccountType.ToString();
        ...
        public ActionResult Check(AccountModels obj)
        {
            ...
            var profile =dbcontext.Profiles.FirstOrDefault(x => x.Email == obj.email && x.Password == obj.password);
            if (profile !=null)
            {
                string type = profile.Account_Type.ToString();
                Session["Type"] = type;
