...
namespace Hospital_Management_System.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult GetData()
        {
            ...
            List<Profile> empList = dbcontext.Profiles.ToList(); ;
        ...
        public ActionResult AddOrEdit(int id = 0)
        {
            ...
            {
                ViewBag.profile = dbcontext.Profiles.Where(x => x.ID == id).FirstOrDefault();
                return View();
        ...
        public ActionResult AddOrEdit(Profile emp)
        {
            ...
            if (emp.ID == 0)
            {
                dbcontext.Profiles.Add(emp);
                dbcontext.SaveChanges();
                return RedirectToAction("ManageBlood", "Admin");
        ...
        public ActionResult Delete(int id)
        {
            ...
            Profile emp = dbcontext.Profiles.Where(x => x.ID == id).FirstOrDefault();
            dbcontext.Profiles.Remove(emp);
            dbcontext.SaveChanges();
